...
const getProducts = asyncHandler(async (req, res) => {
  const pageSize = 8; // Change this to whatever number of items you want per page
  const page = Number(req.query.pageNumber) || 1;

  // Search Logic: Match keyword in name (case insensitive)
  ...
  // Return products + pagination info
